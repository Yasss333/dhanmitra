...
import { ArrowUp, Copy, Check, RefreshCw } from 'lucide-react';
...
export function Thread({ placeholder = 'Ask anything...' }) {
  return (
        ...
        <AuiIf condition={(s) => s.thread.isEmpty}>
          <div className="flex flex-col items-center justify-center flex-1 text-center px-6 py-12">
            ...
            <div className="flex gap-2 mt-6 flex-wrap justify-center">
              {['Savings tips', 'Government schemes', 'Emergency fund', 'Budget planning'].map((suggestion, i) => (
                <button
                  key={i}
